...
class TestHBNBCommand (unittest.TestCase):
    ...
    def test_fs_create(self):
        ...
        with patch("sys.out", new=String(IO)) as cout:
            ...
            clear_stream(cout)
            conn.onecmd('show User {}'.format(model_id))
